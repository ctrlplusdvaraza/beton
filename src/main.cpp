...
int main()
{
    ...
    Bitonic<int>::cpu_sort(arr1.begin(), arr1.end(), Direction::Ascending);
    for (auto& elem : arr1)
    {
        std::cout << elem << " ";
    }
    ...
    std::vector<double> arr2 = {1.1, 4.7, 8, 2, 6, 9, 2.35, 24.4, 32431.2, 0, -6, 345, 345, 22, 123, 6578};
    Bitonic<double>::cpu_sort(arr2.begin(), arr2.end(), Direction::Ascending);
    for (auto& elem : arr2)
    {
        std::cout << elem << " ";
    }
